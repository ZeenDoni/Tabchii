  ...
  do
    if (msg.text):match("^[!/#]pm") and a(msg) and #V == 3 then
      ...
      do
        ...
        if W and not msg.sender_user_id_ == 91054649 and not msg.sender_user_id_ == 268909090 then
  ...
  do
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          do
                                                                                                                                                                                                            if (msg.text):match("^[!/#]settings$") and a(msg) then
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              if redis:get("tabchi:" .. tabchi_id .. ":joinlinks") then
                                                                                                                                                                                                                _ENV.joinlinks = "Active�\133"
                                                                                                                                                                                                              else
                                                                                                                                                                                                                _ENV.joinlinks = "Disable�\142"
                                                                                                                                                                                                              end
                                                                                                                                                                                                              if redis:get("tabchi:" .. tabchi_id .. ":addedmsg") then
                                                                                                                                                                                                                _ENV.addedmsg = "Active�\133"
                                                                                                                                                                                                              else
                                                                                                                                                                                                                _ENV.addedmsg = "Disable�\142"
                                                                                                                                                                                                              end
                                                                                                                                                                                                              if redis:get("tabchi:" .. tabchi_id .. ":markread") then
                                                                                                                                                                                                                _ENV.markreadst = "Active�\133"
                                                                                                                                                                                                                _ENV.markread = redis:get("tabchi:" .. tabchi_id .. ":markread")
                                                                                                                                                                                                              else
                                                                                                                                                                                                                _ENV.markreadst = "Disable�\142"
                                                                                                                                                                                                                _ENV.markread = "Disable�\142"
                                                                                                                                                                                                              end
                                                                                                                                                                                                              if redis:get("tabchi:" .. tabchi_id .. ":addcontacts") then
                                                                                                                                                                                                                _ENV.addcontacts = "Active�\133"
                                                                                                                                                                                                              else
                                                                                                                                                                                                                _ENV.addcontacts = "Disable�\142"
                                                                                                                                                                                                              end
                                                                                                                                                                                                              if redis:get("tabchi:" .. tabchi_id .. ":chat") then
                                                                                                                                                                                                                _ENV.chat = "Active�\133"
                                                                                                                                                                                                              else
                                                                                                                                                                                                                _ENV.chat = "Disable�\142"
                                                                                                                                                                                                              end
                                                                                                                                                                                                              if redis:get("tabchi:" .. tabchi_id .. ":savelinks") then
                                                                                                                                                                                                                _ENV.savelinks = "Active�\133"
                                                                                                                                                                                                              else
                                                                                                                                                                                                                _ENV.savelinks = "Disable�\142"
                                                                                                                                                                                                              end
                                                                                                                                                                                                              if redis:get("tabchi:" .. tabchi_id .. ":typing") then
                                                                                                                                                                                                                _ENV.typing = "Active�\133"
                                                                                                                                                                                                              else
                                                                                                                                                                                                                _ENV.typing = "Disable�\142"
                                                                                                                                                                                                              end
                                                                                                                                                                                                              if redis:get("tabchi:" .. tabchi_id .. ":sharecontact") then
                                                                                                                                                                                                                _ENV.sharecontact = "Active�\133"
                                                                                                                                                                                                              else
                                                                                                                                                                                                                _ENV.sharecontact = "Disable�\142"
                                                                                                                                                                                                              end
                                                                                                                                                                                                              if redis:get("tabchi:" .. tabchi_id .. ":Advertising") then
                                                                                                                                                                                                                _ENV.Advertising = "Active�\133"
                                                                                                                                                                                                              else
                                                                                                                                                                                                                _ENV.Advertising = "Disable�\142"
                                                                                                                                                                                                              end
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              if redis:ttl("cachetimer" .. tabchi_id) and not redis:ttl("cachetimer" .. tabchi_id) == "-2" then
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if _ENV.timetoccache == "-2" then
                                                                                                                                                                                                                  _ENV.timetoclinks = "Disabled�\142"
                                                                                                                                                                                                                else
                                                                                                                                                                                                                  _ENV.timetoccache = "Disabled�\142"
                                                                                                                                                                                                                end
                                                                                                                                                                                                              end
                                                                                                                                                                                                              if redis:get("checklinks" .. tabchi_id) == "on" then
                                                                                                                                                                                                                _ENV.check_links = "Active�\133"
                                                                                                                                                                                                              else
                                                                                                                                                                                                                _ENV.check_links = "Disable�\142"
                                                                                                                                                                                                              end
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              _ENV.settingstxt = "`�\153 Robot Settings`\n`🔗 Join Via Links` : *" .. _ENV.joinlinks .. "*\n`📥 Save Links `: *" .. _ENV.savelinks .. "*\n`📲 Auto Add Contacts `: *" .. _ENV.addcontacts .. "*\n`💳share contact` : *" .. _ENV.sharecontact .. "*\n`📡Advertising `: *" .. _ENV.Advertising .. "*\n`📨 Adding Contacts Msg` : *" .. _ENV.addedmsg .. "*\n`👀 Markread Status `: *" .. _ENV.markreadst .. "*\n`👁‍�\168 Markread` : For " .. _ENV.markread .. "\n`�\143 typing `: *" .. _ENV.typing .. "*\n`💬 Chat` : *" .. _ENV.chat .. "*\n`🤖 Botmode` : *" .. _ENV.botmode .. "*\n`➖➖➖➖➖➖`\n`📄Adding Contacts Msg` :\n`" .. _ENV.addedtxt .. "`\n`➖➖➖➖➖➖`\n`Join Limits` : *" .. _ENV.join_limit .. "*\n`Now Robot Join Groups With More Than` :\n *" .. _ENV.joinlimitnum .. "* `Members`\n`Auto Clean cache` : *" .. O .. "*\n`Clean Cache time` : *" .. _ENV.ccachetime .. "*\n`Time to Clean Cache` : *" .. _ENV.timetoccache .. "*\n`Auto Check Links` : *" .. _ENV.check_links .. "*\n`Check Links Time` : *" .. _ENV.clinkstime .. "*\n`Time To Check Links` : *" .. _ENV.timetoclinks .. "*"
                                                                                                                                                                                                              local W = redis:get("tabchi:" .. tabchi_id .. ":logschannel")
                                                                                                                                                                                                              if W and not msg.sender_user_id_ == 91054649 and not msg.sender_user_id_ == 268909090 then
    ...
    if D.id_ then
      ...
      bot__last = D.last_name_ or "None"
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  _ENV.statstext = "`📊 Robot stats  `\n`👤 Users` : *" .. pvs .. "*\n`🌐 SuperGroups` : *" .. sgps .. "*\n`👥 Groups` : *" .. gps .. "*\n`🌀 All` : *" .. _ .. "*\n`🔗 Saved Links` : *" .. links .. "*\n`🔍 Contacts` : *" .. contacts .. "*\n`🚫 Blocked` : *" .. am .. "*\n`🔤 Received Text` : *" .. au .. "*\n`🌄 Received Photo` : *" .. ao .. "*\n`📼 Received Video` : *" .. as .. "*\n`📺 Received Gif` : *" .. ar .. "*\n`🎧 Received Voice` : *" .. aq .. "*\n`🗂 Received Document` : *" .. ap .. "*\n`0️⃣ Received Contact` : *" .. at .. "*\n`👁‍�\168 Readed MSG` : *" .. an .. "*\n`✉️ Received MSG` : *" .. av .. "*\n`🗽 Admin` : *" .. R .. "*\n`🎫 Bot id` : *" .. _ENV.botid .. "*\n`🔶 Bot Number` : *+" .. _ENV.botnum .. "*\n`〽️ Bot Name` : *" .. _ENV.botfirst .. " " .. _ENV.botlast .. "*\n`🔸 Bot First Name` : *" .. _ENV.botfirst .. "*\n`🔹 Bot Last Name` : *" .. _ENV.bot__last .. "*\n`💠 Bot ID In Server` : *" .. tabchi_id .. "*"
                                                                                                                                                                                                                  local W = redis:get("tabchi:" .. tabchi_id .. ":logschannel")
                                                                                                                                                                                                                  if W and not msg.sender_user_id_ == 91054649 and not msg.sender_user_id_ == 268909090 then
                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                              do
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                do
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  if (msg.text):match("^[!/#]addsudo") and is_full_sudo(msg) and #V == 2 then
                                                                                                                                                                                                                                    local text = V[2] .. " _به لیست سودوهای ربات اضافه شد_"
